...
export default {
  fetch: withSupabase({ auth: "user" }, async (req, ctx) => {
    ...
    try {
      ...
      // Do not query workspace_invitations here.
      // The browser never needs access to invitation records, and this optional
      // duplicate check can fail because of database/RLS/schema differences.
      // We simply create a fresh invitation token and send it. Older invitations
